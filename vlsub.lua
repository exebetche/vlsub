...
function interface_config()
  ...
  dlg:add_label(lang["int_display_iso_code"]..':', 1, 6, 0, 1)
  input_table['isoLangExt'] = dlg:add_dropdown(3, 6, 1, 1)
  ...
  dlg:add_label(
	...
	-- Password
	dlg:add_label(lang["int_os_password"]..':', 1, 1, 0, 1)
	input_table['os_password'] = dlg:add_text_input(type(openSub.option.os_password) == "string" and openSub.option.os_password or "", 2, 9, 2, 1)
